    ...
    <div class="cards-container">
      <?php if($card['block']): $count = count($card['block']);?>
        <?php foreach($card['block'] as $index => $block):?>
          ...
          ?>">
            <div class="card <?php if($block['image_size'] == "full"): ?>full<?php endif; ?> <?php if($block['image_size'] == "contained"): ?>contained<?php endif; ?>" <?php if($block['image_size'] != "full"): ?>  style="background-color: <?php echo esc_attr($block['card_background_colour']); ?>;" <?php endif; ?>>
